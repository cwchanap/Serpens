...
export const en = {
	...
	logisticsRouteInspector: {
		ariaLabel: 'Logistics route inspector',
		close: 'Close logistics route inspector',
		eyebrow: 'Logistics route',
		...
		attemptCapacity: 'Attempt capacity',
		dispatchedQuantity: 'Dispatched quantity',
		unusedCapacity: 'Unused capacity',
		unmetDestinationNeed: 'Unmet destination need',
